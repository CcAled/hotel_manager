...
j&&(j=j.replace(/style/i,"static.bootstrap.css.style").replace(/title/i,"title"),j.indexOf("title")>-1&&(k.title=!1),j.indexOf("class")>-1&&(n=void
...
k.tabindex),k.hasOwnProperty("static.bootstrap.css.style")&&(j+=k.style,delete
